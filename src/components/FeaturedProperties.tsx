  ...
  return (
    <section id="properties" className="py-20 lg:py-28 bg-[#fcfaf2] relative overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
              ...
              <button
                ...
                className={`px-3.5 sm:px-5 py-2 sm:py-2.5 rounded-full text-[11px] sm:text-xs font-bold uppercase tracking-wider transition-all duration-300 cursor-pointer ${
                  selectedFilter === f.value
                    ? 'bg-[#0a1a2f] text-[#c5a021] border-2 border-[#c5a021] shadow-lg scale-102'
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
          {filteredProperties.map((property) => (
            <div
              ...
              className="rounded-2xl bg-white border-2 border-[#c5a021]/30 hover:border-[#c5a021] shadow-lg hover:shadow-2xl transition-all duration-500 flex flex-col overflow-hidden group card-hover-luxury"
            >
              {/* Image & Badges */}
              <div className="relative aspect-[16/10] overflow-hidden bg-[#0a1a2f]">
                ...
                <button
                  ...
                  className="absolute bottom-3 right-3 sm:bottom-3.5 sm:right-3.5 p-2 sm:p-2.5 rounded-xl bg-white/95 hover:bg-white text-[#0a1a2f] shadow-lg transition-transform active:scale-90 hover:scale-110 min-w-[36px] min-h-[36px] flex items-center justify-center"
                >
              ...
              <div className="p-4 sm:p-6 flex-1 flex flex-col justify-between">
                ...
                <div className="flex items-center gap-2.5 pt-2">
                  <a
                    ...
                    className="flex-1 inline-flex items-center justify-center gap-2 py-3 px-4 rounded-full text-xs font-bold uppercase tracking-widest text-[#0a1a2f] bg-[#c5a021] hover:bg-[#0a1a2f] hover:text-white transition-all shadow-md active:scale-98 cursor-pointer"
                  >
        ...
        {onNavigateProperties && (
          <div className="mt-12 text-center">
            <button
              ...
              className="inline-flex items-center gap-3 px-8 py-4 rounded-full bg-[#0a1a2f] hover:bg-[#c5a021] text-[#c5a021] hover:text-[#0a1a2f] border-2 border-[#c5a021] font-bold text-xs uppercase tracking-widest transition-all duration-300 shadow-2xl group cursor-pointer active:scale-98 animate-pulse-glow"
            >
        ...
        <div className="mt-16 text-center bg-[#0a1a2f] p-8 sm:p-10 rounded-2xl border-2 border-[#c5a021] shadow-2xl max-w-3xl mx-auto animate-pulse-glow relative overflow-hidden">
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center gap-2 px-8 py-3.5 rounded-full font-bold text-xs uppercase tracking-widest text-[#0a1a2f] bg-[#c5a021] hover:bg-white transition-all shadow-xl active:scale-95 cursor-pointer animate-shimmer"
          >
            <MessageCircle className="w-4 h-4 fill-current" />
