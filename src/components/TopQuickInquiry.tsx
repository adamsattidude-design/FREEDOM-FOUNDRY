  ...
  return (
    ...
    >
      <motion.div
        ...
        className="rounded-2xl sm:rounded-3xl bg-white border-2 border-[#c5a021] shadow-2xl overflow-hidden p-4 sm:p-8 lg:p-10 relative"
      >
        ...
        <AnimatePresence mode="wait">
          {submitted ? (
            <motion.div
              ...
              className="rounded-2xl bg-[#0a1a2f] border-2 border-[#c5a021] text-white p-6 sm:p-8 text-center shadow-xl"
            >
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center gap-3">
                <motion.a
                  ...
                  className="w-full sm:w-auto inline-flex items-center justify-center gap-2 px-6 py-3 rounded-full text-xs font-bold uppercase tracking-wider text-[#0a1a2f] bg-[#c5a021] hover:bg-white transition-all shadow-md cursor-pointer"
                >
            ...
            >
              ...
              {errorMessage && (
                <motion.div
                  ...
                  className="p-3.5 rounded-xl bg-red-50 border border-red-200 text-red-800 text-xs flex items-center gap-2"
                >
              ...
              <div className="pt-2">
                <motion.button
                  ...
                  className="w-full py-3.5 px-6 rounded-xl font-bold text-xs uppercase tracking-widest text-[#0a1a2f] bg-[#c5a021] hover:bg-[#0a1a2f] hover:text-white shadow-xl transition-all flex items-center justify-center gap-2 cursor-pointer disabled:opacity-60 animate-shimmer"
                >
                  {isSubmitting ? (
                    <>
